...
% =======================================================================
\begin{frame}[t]{Why Do Some Businesses Connect Instead of Produce?}
\begin{columns}[T]
...
% =======================================================================
\begin{frame}[t]{Your Group Chat Proves a Point About Network Effects}
\begin{columns}[T]
\begin{column}{0.55\textwidth}
...
\vspace{1mm}
\begin{block}{}
\footnotesize \textbf{Four types in the lecture:} direct (same-side, like your group chat), indirect (cross-side, like cardholders and merchants), data (usage improves algorithms), and negative (congestion, spam, fraud).
\end{block}
\end{frame}
...
% =======================================================================
\begin{frame}[t]{Day One: Nobody Shows Up --- Now What?}
\begin{columns}[T]
\begin{column}{0.55\textwidth}
\small
...
% =======================================================================
\begin{frame}[t]{The Moment a Platform Becomes Unstoppable}
\begin{columns}[T]
\begin{column}{0.55\textwidth}
...
% =======================================================================
\begin{frame}[t]{Follow the Money: How Platforms Actually Get Paid}
\begin{columns}[T]
\begin{column}{0.55\textwidth}
...
% =======================================================================
\begin{frame}[t]{What the Lecture Covers: Eight Sections}
\small
\begin{center}
\begin{tabular}{c l l}
\toprule
