...
\begin{itemize}
\item Basic blockchain concepts
\item Smart contract fundamentals
\item Token standards (ERC-20)
\item DeFi protocol basics
\end{itemize}

\vspace{3mm}
\textbf{Mathematical Prerequisites:}
\begin{itemize}
\item Voting theory basics
\item Understanding of ratios/percentages
\item Square root calculations (for quadratic voting)
\end{itemize}
\end{column}
\begin{column}{0.48\textwidth}
\textbf{Conceptual Foundations:}
\begin{itemize}
\item Traditional corporate governance
\item Democratic voting systems
\item Game theory fundamentals
...
\end{column}
\begin{column}{0.48\textwidth}
\textbf{The Plutocracy Problem:}
\begin{itemize}
\item Wealth = Power (by design)
\item Large holders dominate decisions
\item ``Decentralized'' often isn't
\item Reflects crypto wealth inequality
\end{itemize}
...
Split 10,000 tokens into 100 wallets:\\
$100 \times \sqrt{100} = 1,000$ votes\\
vs. $\sqrt{10,000} = 100$ votes

Quadratic voting requires identity!
\end{alertblock}
\end{column}
\end{columns}
\end{frame}
...
\vspace{3mm}
\textbf{Formula:}
$$\text{Conviction} = \text{Balance} \times (1 - d^t)$$
where $d$ = decay rate, $t$ = time staked

\vspace{2mm}
Typically reaches maximum after $\sim$30 days.
\end{column}
\begin{column}{0.48\textwidth}
\begin{tikzpicture}[scale=0.7, transform shape]
\begin{axis}[
...
% =====================================================================
% SLIDE 12: Optimistic Governance
% =====================================================================
...
\item Execution happens immediately
...
% =====================================================================
% SLIDE 13: The Plutocracy Problem
% =====================================================================
...
% =====================================================================
% SLIDE 14: Real DAO Concentration Data
% =====================================================================
...
% =====================================================================
% SLIDE 15: Governance Attack Vectors
% =====================================================================
...
% =====================================================================
% SLIDE 17: Governance Defenses - Timelocks
% =====================================================================
...
% =====================================================================
% SLIDE 19: Snapshot Voting Defense
% =====================================================================
...
% =====================================================================
% SLIDE 22: On-Chain vs Off-Chain Governance
% =====================================================================
...
% =====================================================================
% SLIDE 23: The Voter Apathy Problem
% =====================================================================
...
% =====================================================================
% SLIDE 24: Code is Law vs Rule of Law
% =====================================================================
...
\begin{columns}[T]
\begin{column}{0.48\textwidth}
\textbf{Exercise 1: Token Distribution}
\begin{itemize}
\item Generate realistic Pareto distributions
\item Visualize wealth concentration
\item Calculate Gini coefficient
\item Compare to real DAO data
\end{itemize}

\vspace{3mm}
\textbf{Exercise 2: Voting Simulation}
\begin{itemize}
\item Simulate proposal voting
\item Model whale vs. community
\item Test different quorum levels
\item Observe outcome patterns
\end{itemize}
\end{column}
\begin{column}{0.48\textwidth}
\textbf{Exercise 3: Attack Scenarios}
\begin{itemize}
...
\vspace{3mm}
\textbf{Exercise 4: Defense Mechanisms}
\begin{itemize}
...
% =====================================================================
% SLIDE 27: Discussion - Governance Tradeoffs
% =====================================================================
...
% =====================================================================
% SLIDE 28: Application - Real DAO Examples
% =====================================================================
\begin{frame}{Application: Real DAO Governance Examples}
\begin{columns}[T]
\begin{column}{0.48\textwidth}
\textbf{MakerDAO:}
\begin{itemize}
...
\textbf{Curve Finance:}
\begin{itemize}
\item veCRV model pioneer
\item Up to 4-year locks
\item Gauge voting for emissions
\item ``Curve Wars'' for control
\end{itemize}
\end{column}
\end{columns}
\end{frame}
...
% =====================================================================
% SLIDE 29: Application - DAO Design Considerations
% =====================================================================
...
% =====================================================================
% SLIDE 30: Application - Future of DAO Governance
% =====================================================================
...
\item \textbf{Soulbound tokens:} Identity-linked voting power
\item \textbf{Futarchy:} Markets predict outcomes
\item \textbf{AI governance:} Automated analysis
\end{itemize}

\vspace{3mm}
\textbf{Legal Developments:}
\begin{itemize}
\item Wyoming DAO LLC law
\item Marshall Islands recognition
\item EU MiCA framework
...
\begin{itemize}
\item Scaling participation
\item Preventing capture
\item Balancing efficiency/decentralization
...
\textbf{Reality:} Without identity systems, whales simply split tokens across wallets to game quadratic voting.
\end{column}
\begin{column}{0.48\textwidth}
