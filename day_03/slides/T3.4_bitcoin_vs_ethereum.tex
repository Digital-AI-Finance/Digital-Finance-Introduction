...
A system is \textbf{Turing-complete} if it can compute anything that is theoretically computable -- like a general-purpose computer.
\end{block}
...
\textbf{Problem:} Both Bitcoin ($\sim$7 TPS) and Ethereum ($\sim$15-30 TPS) are slow compared to Visa (24,000 TPS).
