...
\vspace{1mm}
{\scriptsize EIP = Ethereum Improvement Proposal -- a formal suggestion to change Ethereum's rules, similar to a bill in parliament.}
...
\vspace{1mm}
\textit{Two different approaches: think of UTXO like having specific bills in your wallet (you can't tear a \$10 bill in half), vs.\ an account balance like a bank (just a number that goes up and down).}
