...
% ============================================================================
% SLIDE 13b: The Credit Scoring Pipeline (cont.)
% ============================================================================
...
\vspace{4mm}
\textbf{Where Bias Enters:}
\begin{itemize}
\item \textbf{Data Collection}: Historical discrimination embedded in records
\item \textbf{Feature Engineering}: Proxy variables that correlate with protected attributes
\item \textbf{Model Training}: Algorithms optimizing for accuracy may amplify existing patterns
\item \textbf{Threshold Setting}: Different cutoffs affect different groups unequally
\end{itemize}

\vspace{3mm}
\bottomnote{Notebook NB04: Walk through each pipeline stage hands-on}
\end{frame}
...
% ============================================================================
% SLIDE 17b: Proxy Variables (cont.)
% ============================================================================
\begin{frame}{Proxy Variables and Disparate Impact (cont.)}
\begin{block}{The Insight}
...
\vspace{4mm}
\textbf{Testing for Disparate Impact:}
\begin{itemize}
\item Compare approval rates across demographic groups
\item Check if error rates differ by group (equalized odds)
\item Test whether removing a proxy changes outcomes significantly
\item Use adversarial debiasing to reduce proxy effects
\end{itemize}

\vspace{3mm}
\textbf{The Dilemma:} Removing proxy variables may reduce predictive accuracy, creating a direct tension between fairness and performance that lenders and regulators must navigate.
\end{frame}
...
% ============================================================================
% SLIDE 19b: Beyond Credit (cont.)
% ============================================================================
\begin{frame}{Beyond Credit: Algorithms Everywhere in Finance (cont.)}
\begin{block}{The Insight}
...
\vspace{4mm}
\textbf{Common Themes Across All Applications:}
\begin{itemize}
\item More data leads to better predictions --- but also deeper surveillance
\item Automation improves speed and consistency --- but reduces human oversight
\item Algorithms can find patterns humans miss --- but those patterns may encode bias
\item Regulation struggles to keep pace with algorithmic innovation
\end{itemize}
\end{frame}
...
% ============================================================================
% SLIDE 20b: The Data Flywheel (cont.)
% ============================================================================
...
``Alternative data is always better for consumers.''
\end{alertblock}
\textbf{Reality}: While alternative data can expand access, it also raises privacy concerns and can introduce new forms of bias through proxy variables.
\end{column}
\end{columns}
\end{frame}

% ============================================================================
% SLIDE 26b: Self-Assessment
% ============================================================================
\begin{frame}{Common Misconceptions (cont.)}
