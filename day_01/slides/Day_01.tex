...
\footnotesize
This system moves \textbf{\$5+ trillion daily}, serves billions, rarely fails catastrophically... but has significant frictions.
\end{frame}
...
\textbf{The Problem:}
\begin{itemize}
\item Stock trade: T+2 (2 business days to settle)
