...
\begin{enumerate}
\item \textbf{1980s--90s}: Statistical arbitrage (using math to find temporary price differences between related assets)
\item \textbf{2000s}: High-frequency trading
\item \textbf{2010s}: Factor investing at scale (choosing investments based on measurable characteristics like company size or recent momentum)
