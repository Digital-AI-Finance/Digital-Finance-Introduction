...
\begin{itemize}
\item \textbf{2017--2020}: Clear separation---ICO boom (2017), crypto winter (2018), DeFi Summer begins (2020)
\item \textbf{2021--2024}: Boundaries blur---PayPal adds crypto buying (2021), Visa settles in USDC (2021), Aave Arc launches (2022), BlackRock files Bitcoin ETF (2023), spot Bitcoin ETFs approved in the US (Jan 2024)
...
{\footnotesize \textbf{Key terms:} \textit{Cross-chain} means moving assets or data between different blockchains (e.g., Ethereum to Solana). \textit{Interoperability} means different systems can work together seamlessly. A \textit{bridge} is software that locks an asset on one chain and issues an equivalent on another.}
